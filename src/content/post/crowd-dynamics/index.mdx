...
tags: ["crowd", "dynamics", "simulation", "computation", "physics", "python", "c++"]
---
...
import screenshot_experiment from './images/screenshot_experiment.png';
import exit1 from './images/exit_1.png';
import exit2 from './images/exit_2.png';
import exit3 from './images/exit_3.png';
import screenshot_experiment_obs1 from './images/screenshot_experiment_obs1.png';
import exit_obs1_1 from './images/exit_obs1_1.png';
import exit_obs1_2 from './images/exit_obs1_2.png';
import exit_obs1_3 from './images/exit_obs1_3.png';
import tools from './images/Tools.png';
import bound_attractor from './images/bound_attractor.png';

<Image src={crowd} alt="Crowd Dynamics"/>
...
## Active Jam Model
![Active Jam Simulation](./images/active-jam.png)
...
<div id="vid" style="display:inline-block;">
  <video width="500" height="500" style="float:left; padding-right: 15px;" muted loop autoplay controls>
    <source src="/videos/crowd-dynamics/Walls.mp4" type="video/mp4"/>
...
## Spawn Zones
<div id="vid" style="display:inline-block;">
  <video width="500" height="500" style="float:right; padding-left: 15px;" muted loop autoplay controls>
    <source src="/videos/crowd-dynamics/SpawnBoxes.mp4" type="video/mp4"/>
  Your browser does not support the video tag.
  </video>
...
<div id="vid" style="display:inline-block;">
  <video width="500" height="500" style="float:left; padding-right: 15px;" muted loop autoplay controls>
    <source src="/videos/crowd-dynamics/Attractors.mp4" type="video/mp4"/>
  Your browser does not support the video tag.
  </video>
...
<div id="scenarios" style="display:inline-block;">
  <Image src={screenshot_experiment} style="float:left;" alt="Experiment 1" width="200" height="200"/>
  <Image src={exit1} style="float:left;" alt="Experiment 1" width="200" height="200"/>
  <Image src={exit2} style="float:left;" alt="Experiment 1" width="200" height="200"/>
  <Image src={exit3} style="float:left;" alt="Experiment 1" width="200" height="200"/>
</div>
<div id="scenarios" style="display:inline-block;">
  <Image src={screenshot_experiment_obs1} style="float:left;" alt="Experiment 1" width="200" height="200"/>
  <Image src={exit_obs1_1} style="float:left;" alt="Experiment 1" width="200" height="200"/>
  <Image src={exit_obs1_2} style="float:left;" alt="Experiment 1" width="200" height="200"/>
  <Image src={exit_obs1_3} style="float:left;" alt="Experiment 1" width="200" height="200"/>
</div>
...
<div id="engine" style="display:inline-block;">
  <Image src={tools} style="float:left;" alt="Experiment 1" width="400" height="400"/>
  <Image src={bound_attractor} alt="Bound Attractor" width="400" height="400"/>
</div>
...
<div height="500">
  <div id="pdf" style="display:inline-block;">
    <object style="width:400; height:300; padding: 5px;" type="application/pdf" data="https://flandan.github.io/images/obs1_figure_Psmooth_vs_Ninside_doorwidth.pdf?#zoom=50&scrollbar=0&toolbar=0&navpanes=0" id="pdf_content">
      <p>PDF cannot be displayed.</p>
    </object>
  </div>
  <div id="pdf" style="display:inline-block;">
    <object style ="width:400; height:300; paddint: 5px;" type="application/pdf" data="https://flandan.github.io/images/obs1_figure_Psmooth_vs_Time_doorwidth.pdf?#zoom=50&scrollbar=0&toolbar=0&navpanes=0" id="pdf_content">
      <p>PDF cannot be displayed.</p>
    </object>
  </div>
</div>
...
You can read more about this project in greater detail in my [thesis](/pdf/Crowd_Modeling.pdf).